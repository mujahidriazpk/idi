...
import footerlogo1 from "../public/img/footerlogo1.png";
import footerlogo2 from "../public/img/footerlogo2.png";
import footerlogo3 from "../public/img/footerlogo3.png";
        ...
        <div className="flex flex-wrap">
          <div className="items-center w-full lg:w-1/2">
            ...
            <div className="flex mt-0 space-x-5 text-white ">
              ...
              <a
                href="https://idiimage.com/wp-content/uploads/2015/10/DB.pdf"
                target="_blank"
                rel="noopener">
                <Image
                  src={footerlogo2}

  ...
  return (
    <>
        ...
        <div className="grid gap-10 lg:grid-cols-2 xl:grid-cols-3">
          <div className="lg:col-span-2 xl:col-auto">
            <div className="flex flex-col justify-between text-center w-full h-full bg-gray-100 px-14 py-14 dark:bg-trueGray-800">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 m-auto inline-block text-red-600">
      ...
      <Container className="pb-0">
        ...
        <div className="my-4 flex-col text-center"><a href="/" className="font-thin text-white bg-[#2164A1] w-auto px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-[#2164A1] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
          Learn More
        </a></div>
      </Container>
      <Form />

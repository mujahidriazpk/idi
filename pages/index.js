...
const Home = () => {
  return (
    <>
      ...
      <Container className="pb-0">
        <div className="grid gap-10 lg:grid-cols-2 xl:grid-cols-4 items-center">
          <div className="flex-row">
            <div className="flex rounded-full bg-[#2164A1] w-60 h-60 m-auto">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-36 h-36 flex justify-center inline-block m-auto text-white">
